...
#define HMM_EXTERN extern
    ...
    !defined(HMM_FLOOR) || !defined(HMM_CEILING)
#include <math.h>
#endif
...
#ifndef HMM_FLOOR
#define HMM_FLOOR floorf
#endif

#ifndef HMM_CEILING
#define HMM_CEILING ceilf
#endif
...
#define Min(a, b) HMM_MIN(a, b)
#define Max(a, b) HMM_MAX(a, b)
#define Abs(a) HMM_ABS(a)
#define Mod(a, m) HMM_MOD(a, m)
#define Square(x) HMM_SQUARE(x)
#define Clamp(v, l, u) (Max(Min(v, u), l))
#define Floor(x) floorf(x)
#define Ceiling(x) ceilf(x)
...
COVERAGE(HMM_Mat3, 1)
HMM_INLINE hmm_mat3 HMM_PREFIX(Mat3)(void)
{
    ASSERT_COVERED(HMM_Mat3);
...
COVERAGE(HMM_Mat4d, 1)
HMM_INLINE hmm_mat3 HMM_PREFIX(Mat3d)(float Diagonal)
{
    ASSERT_COVERED(HMM_Mat4d);

    hmm_mat3 Result = HMM_PREFIX(Mat3)();
...
// This method taken from Mike Day at Insomniac Plores.
