...
#define PLORE_ADVANCED_PHOTO_EDITOR          { .Name = "GIMP",            .Shell = "gimp" }
#define PLORE_MEDIA_HANDLER                  { .Name = "Media Player",    .Shell = "vlc"  }
#define PLORE_BASIC_PHOTO_EDITOR             PLORE_ADVANCED_PHOTO_EDITOR
